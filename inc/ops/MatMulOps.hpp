...
namespace tensor::ops
{
    ...
    protected:
        ...
        static constexpr IterationKind iter_kind_ = IterationKind::MATMUL;
     ...
     * 
     * MatmulTransposeA or MatmultransposeB: fusion of transpose and matmul
     * MatmulAdd(linear): fused matmul and bias sum.
     */
